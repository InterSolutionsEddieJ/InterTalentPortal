  ...
  return (
    <div className="flex flex-col items-center gap-4 mt-8 pt-6 border-t border-gray-200">
      ...
      <button
        onClick={onShowMore}
        disabled={loading}
        className="px-8 py-3 bg-[#1e3a5f] hover:bg-[#2d5a8f] text-white rounded-lg font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-2"
      >
        {loading ? (
          <>
